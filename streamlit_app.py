...
def main():
    ...
    with col1:
        st.image("https://www.colibrigarden.com/wp-content/uploads/2020/06/logo-footer.png", width=100)  # Direct link to logo
    with col2:
  ...
  # Bokyna Logo from Facebook (not guaranteed to work)
    ...
    with col3:
        st.image("https://lookaside.fbsbx.com/lookaside/crawler/media/?media_id=100070045196671", width=100)  # Facebook-hosted image
    with col4:
